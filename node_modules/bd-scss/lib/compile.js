...
const formatFile = (file) => { // I messed with this to get rid of some padding. Becuase Fluxer doesnt support github imports. No import and much padding makes the dist file ugly.
    return file.meta + file.base + '' + file.imports.join('') + '\n' + file.root + '' + file.css;
};
